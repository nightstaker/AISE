# Skill Spec: conflict_resolution

## 1. Metadata
- `skill_id`: `conflict_resolution`
- `module`: `aise.skills.conflict_resolution.scripts.conflict_resolution`
- `class`: `ConflictResolutionSkill`
- `implementation`: `src/aise/skills/conflict_resolution/scripts/conflict_resolution.py`
- `license`: `Apache-2.0` (see `LICENSE.txt`)

## 2. Purpose
Resolve conflicts between agents by analyzing trade-offs and making decisions
