# Skill Spec: user_story_writing

## 1. Metadata
- `skill_id`: `user_story_writing`
- `module`: `aise.skills.user_story_writing.scripts.user_story_writing`
- `class`: `UserStoryWritingSkill`
- `implementation`: `src/aise/skills/user_story_writing/scripts/user_story_writing.py`
- `license`: `Apache-2.0` (see `LICENSE.txt`)

## 2. Purpose
Generate user stories with acceptance criteria from structured requirements
...
## 5. Outputs
- Output artifact type: `ArtifactType.USER_STORIES`
