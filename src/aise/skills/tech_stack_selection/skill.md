# Skill Spec: tech_stack_selection

## 1. Metadata
- `skill_id`: `tech_stack_selection`
- `module`: `aise.skills.tech_stack_selection.scripts.tech_stack_selection`
- `class`: `TechStackSelectionSkill`
- `implementation`: `src/aise/skills/tech_stack_selection/scripts/tech_stack_selection.py`
- `license`: `Apache-2.0` (see `LICENSE.txt`)

## 2. Purpose
Select and justify technology stack based on project requirements
...
## 5. Outputs
- Output artifact type: `ArtifactType.TECH_STACK`
- Producer: `architect`
