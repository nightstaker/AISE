# Skill Spec: requirement_analysis
...
- `implementation`: `src/aise/skills/requirement_analysis/scripts/requirement_analysis.py`
- `license`: `Apache-2.0` (see `LICENSE.txt`)

## 2. Purpose
Analyze raw input and produce structured requirements (functional, non-functional, constraints)
